...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Mero features */
        {"mero", "masternode", &masternode, true, true, false},
        {"mero", "listmasternodes", &listmasternodes, true, true, false},
        {"mero", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mero", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mero", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mero", "masternodedebug", &masternodedebug, true, true, false},
        {"mero", "startmasternode", &startmasternode, true, true, false},
        {"mero", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mero", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mero", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mero", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mero", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mero", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mero", "mnbudget", &mnbudget, true, true, false},
        {"mero", "preparebudget", &preparebudget, true, true, false},
        {"mero", "submitbudget", &submitbudget, true, true, false},
        {"mero", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mero", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mero", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mero", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mero", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mero", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mero", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mero", "checkbudgets", &checkbudgets, true, true, false},
        {"mero", "mnsync", &mnsync, true, true, false},
        {"mero", "spork", &spork, true, true, false},
        {"mero", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mero", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use merod, or the -server option to mero-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mero-cli " + methodname + " " + args + "\n";
}
