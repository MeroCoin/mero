...
This mechanism has been integrated into Bitcore-Node-Mero which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Mero-Project/insight-api-mero#web-socket-api](https://github.com/Mero-Project/insight-api-mero#web-socket-api) 
* API: [https://github.com/Mero-Project/insight-api-mero#swifttx-transactions](https://github.com/Mero-Project/insight-api-mero#swifttx-transactions) 
...
By default, the Mero Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Mero Core daemon:
