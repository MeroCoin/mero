...
In order to support loading of multiple wallets in mero-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mero.cpp.
...
Changes to mero.cpp
----------------------
mero.cpp is the entry point into mero-qt, and as such, will require some minor modifications to provide hooks for
